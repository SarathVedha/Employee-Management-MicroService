...
import com.vedha.employee.dto.ErrorMessageDTO;
...
public class GlobalException { //ResponseEntityExceptionHandler
    ...
    public ResponseEntity<ErrorMessageDTO> handleDepartmentException(EmployeeException employeeException, WebRequest webRequest) {

        ErrorMessageDTO err01 = ErrorMessageDTO.builder().errorCode("ERR01")
                .errorMessage(employeeException.getMessage())
